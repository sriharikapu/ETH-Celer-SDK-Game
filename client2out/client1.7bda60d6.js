...
(async function () {
  ...
  await timeout(2000); //openEthChannel(amountWei: string, peerAmountWei: string): Promise<string>
  ...
  sessionID = await client.createAppSession(appInfo, stateValidator); //only client1 code below:
